...
export const Rooms = () => {
    ...
    return (
        <div className="flex flex-col justify-between min-h-screen">
            <UserStatusDropdown />
            <header className="flex justify-center items-center mx-auto w-100 md:w-[800px] lg:w-[1000px] xl:w-[1200px]">
                <svg
            ...
            <footer className="bg-white border-t flex justify-center items-center">
                <div className="flex justify-between xl:w-[1200px] py-12">
                    <Button
                        ...
                        color="green"
                        variant="outline"
                        className="border-b-4 text-black w-[160px] hover:bg-green-100"
                    >
                        Skip
                    </Button>
                    ...
                    <Button
                        ...
                        color="green"
                        variant="soft"
                        className="border-b-4 text-black w-[160px] bg-green-200 hover:bg-green-300 transition-all duration-200"
                    >
                        Submit
                    </Button>
                </div>
